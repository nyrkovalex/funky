...
func (s Slice) Filter(fn func(interface{}) bool) Slice {
	var result Slice
	for _, item := range s {
		if fn(item) {
...
func (s Slice) Map(fn func(interface{}) interface{}) Slice {
	var result Slice
	for _, item := range s {
...
func (s Slice) Reduce(fn func(interface{}, interface{}) interface{}) interface{} {
